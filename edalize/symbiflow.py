...
class Symbiflow(Edatool):
    ...
    def configure_nextpnr(self):
        ...
        nextpnr_edam = {
            ...
            "tool_options": {
                "nextpnr": {"arch": "xilinx", "nextpnr_as_subtool": True,}
            },
        }

        nextpnr = getattr(import_module("edalize.nextpnr"), "Nextpnr")(
            nextpnr_edam, self.work_root
        )
        nextpnr.configure()
        ...
        self.render_template(
            "symbiflow-nextpnr-makefile.j2", "Makefile", makefile_params
        )
