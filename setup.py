...
setup(
    ...
    package_data = {'edalize' : [
        ...
        'templates/symbiflow/nextpnr-fpga_interchange-makefile.j2',
        'templates/symbiflow/symbiflow-fasm2bels-tcl.j2',
        'templates/symbiflow/yosys-script-nextpnr-fpga_interchange-tcl.j2',
        'templates/symbiflow/yosys-script-nextpnr-xilinx-fasm2bels-tcl.j2',
